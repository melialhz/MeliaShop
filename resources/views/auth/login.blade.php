        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
           <form action="{{ route('login') }}" method="POST">
              ...
              <div class="d-flex justify-content-between align-items-center">
                 ...
                 <a href="{{ route('password.request') }}" class="text-body">Vous avez Oublier le mot de passe ?</a>
                  @endif
              </div>
              <div class="d-flex my-4 justify-content-center flex-column mx-4 mb-3 mb-lg-4">
               ...
               <p class="small fw-bold mt-2 pt-1 mb-0">Vous n'avez pas de compte !!     <a href="{{url('/register')}}"
