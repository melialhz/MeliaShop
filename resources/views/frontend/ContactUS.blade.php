...
<section class="mb-4">
    ...
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">Pour n'importe quel questions n'hésitez pas à nous contacter ! On repondra avec joie et beauté</p>
    ...
    <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
            ...
            <div class="text-center text-md-left">
                <a class="w-100 p-2 message btn btn-outline-primary" type="button">Envoi</a>
            </div>
...
<script>
 $('.message').click(function(e){
            ...
            $.ajax({
                ...
                {
                    if(response.status === "Please Login First ma belle...")
                    {
                    ...
                    else if(response.status === undefined)
                    {
                        ...
                        swal("Oops...", `le message ne peut pas etre envoyé`, "info");
                    }
                    else if(response.status === 'Remplissez le formulaire correctement SVP!')
                    {
